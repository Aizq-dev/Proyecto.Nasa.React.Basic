  ...
  return (
    <>
      <div className="input_rover">
        {date === "2012-08-06" && (
          <p>
            Las primeras fotos realizas por el rover son estas con fecha
            2012-08-06{" "}
          </p>
        )}
        <p>
        ...
        <Input funcion={handleInput_rover} />
        {photoData.length > 0 && (
          <>
            <p>
              Los dias en Marte son mas largos que en la Tierra por lo tanto los
              dias en marte se cuentan por soles{" "}
            </p>
      ...
      <div className="container_rover">
        ...
        {photoData.length > 0 &&
          photoData.slice(0, 24).map((photo) => (
            <div key={photo.id}>
        ...
        {photoData.length === 0 && (!loadingAPI || !loading) && (
